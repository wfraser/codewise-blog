<?php
    ...
    **
    ** Copyright (C) 2004 SourceForge OpenBoard Project Developers and others.
    ** All rights reserved;
    **   see http://openboard.sourceforge.net/openboard_license_1.0.html
    **   for license info.
    **
    ** See http://openboard.sourceforge.net/l1_mysql for updates and other info.
    **
    ** Changes since last version (1.6.2):
    ** + version up to 1.6.3
    ** + fixed some problems with $php_errormessage
    ** + removed literal "<b>"'s from error output
    ** + fixed GRAVE bug in insert() which didn't compile the WHERE condition
    **   properly.
    **
    **
    ** August 14, 2005
